      ...
      <div className="space-y-4">
        {clusters.map((cluster, i) => (
          <div key={i} className="rounded-lg border border-ink-100 bg-ink-50/60 p-3">
            <span className="inline-flex items-center rounded-full bg-surface px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-ink-600 ring-1 ring-ink-200">
